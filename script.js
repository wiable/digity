...
oneAdditionalPageCheckbox.on("change", function () {
  updateTotalAmount();
});

threeAdditionalPageCheckbox.on("change", function () {
  updateTotalAmount();
});

fiveAdditionalPageCheckbox.on("change", function () {
  updateTotalAmount();
});

aboutUsPresentationPageCheckbox.on("change", function () {
  updateTotalAmount();
});

teamPresentationPageCheckbox.on("change", function () {
  updateTotalAmount();
});

companyHistoryPresentationPageCheckbox.on("change", function () {
  updateTotalAmount();
});

additionalAboutUsPage.on("change", function () {
  updateTotalAmount();
});

additionalCompanyNewsPage.on("change", function () {
  updateTotalAmount();
});

additionalPressPage.on("change", function () {
  updateTotalAmount();
});

additionalDirectSalePage.on("change", function () {
  updateTotalAmount();
});

additionalAdsSpecialPage.on("change", function () {
  updateTotalAmount();
});

additionalfedOptPage.on("change", function () {
  updateTotalAmount();
});

additionalCreationNewsletter.on("change", function () {
  updateTotalAmount();
});

additionalDiscussionForum.on("change", function () {
  updateTotalAmount();
});

additionalOneOnlineGame.on("change", function () {
  updateTotalAmount();
});

additionalChatFunction.on("change", function () {
  updateTotalAmount();
});

additionalInteractionWeb2.on("change", function () {
  updateTotalAmount();
});

additionalOfferFacebook.on("change", function () {
  updateTotalAmount();
});

additionalFAQ.on("change", function () {
  updateTotalAmount();
});

additionalCaseStudies.on("change", function () {
  updateTotalAmount();
});

additionalTutorials.on("change", function () {
  updateTotalAmount();
});

additionalDownloadsPage.on("change", function () {
  updateTotalAmount();
});

additionalMultilingualism.on("change", function () {
  updateTotalAmount();
});
